...
/**
 * Created by zes on 17-3-18 10:16
 */
public class InteractAdapter extends BaseRecycleAdapter<String> {
    public InteractAdapter(Context context, List<String> datas, int layoutId) {
