...
/**
 * Created by zes on 17-3-5 23:16
 */
public class MineAdapter extends BaseRecycleAdapter<String> {
    public MineAdapter(Context context, List<String> datas, int layoutId) {
